...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (mImageCache != null) {
            if(data instanceof ImageFetcher.ImageData)
                value = mImageCache.getBitmapFromMemCache(((ImageFetcher.ImageData)data).imageSavePath);
            else
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, BitmapDrawable> {
        ...
        protected BitmapDrawable doInBackground(Object... params) {
            ...
            data = params[0];
            final String dataString = (data instanceof ImageFetcher.ImageData)?((ImageFetcher.ImageData)data).imageSavePath: String.valueOf(data);
            Bitmap bitmap = null;
