...
public class MenuListView extends ExpandableListView
{
    ...
    {
//        Menu menu = mAdapter.getListData();
//        if(!isPremium)
//        {
//            menu.getItem(0).setTitle("Remove ADS");
//            menu.getItem(0).setIcon(R.drawable.ic_ads);
//        }
//        else
//        {
//
//            menu.getItem(0).setTitle("Library");
//            menu.getItem(0).setIcon(R.drawable.ic_controller);
//        }
//
//        mAdapter.notifyDataSetChanged();
    }

    public void setHideGame(boolean hide_game)
    {
        Menu menu = mAdapter.getListData();
        if(hide_game)
        {
            menu.getItem(0).setTitle("Add Game");
//            menu.getItem(0).setIcon(R.drawable.ic_ads);
        }
        else
        {
...
//            menu.getItem(0).setIcon(R.drawable.ic_controller);
    ...
    public static class MenuListAdapter extends BaseExpandableListAdapter
    {
        ...
        public Menu getListData() {
            return mListData;
        }

        public void setListData(Menu mListData) {
